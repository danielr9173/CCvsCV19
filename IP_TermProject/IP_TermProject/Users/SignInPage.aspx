<%@ Page Title="Corpus Christi vs. COVID-19" Language="C#" UnobtrusiveValidationMode="None" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="SignInPage.aspx.cs" Inherits="IP_TermProject.WebForm3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Page_Main" runat="server">
    ...
    <asp:Timer ID="Timer2" runat="server" Enabled="False" Interval="3500" OnTick="Timer2_Tick"></asp:Timer>
    ...
    <div style="text-align: center; margin: 4em 0 6em 0;">
        ...
        <table style="text-align: center; width: 45%; margin: auto; height: 128px;" runat="server" id="Table1">
            <tr>
                <td style="width: 25%">
